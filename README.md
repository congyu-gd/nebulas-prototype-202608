...
disk or a capture from the computer's camera — but its list is a ledger
(vendor · issued · total), and a row opens as the invoice itself, amounts
re-added rather than trusted, with one way back. The calendar reads a week as a time grid or a month as a day grid
